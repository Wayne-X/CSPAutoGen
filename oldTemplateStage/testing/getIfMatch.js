...
fs.readFile(scriptAddr, 'utf8', function (err,data) {
	...
	fs.readFile(listAddr, 'utf8', function (err,data) {
		if (err) {
			console.log("Bad script source address: " + listAddr);
			return;
		}
...
function doYes(){
	fs.readFile("yes", 'utf8', function (err,data) {
	if (err) {
		console.log("Bad script source address: " + scriptAddr);
		return;
	}
	...
	fs.writeFile("yes", data, function (err) {
...
function doNo(){
	fs.readFile("no", 'utf8', function (err,data) {
	if (err) {
		console.log("Bad script source address: " + scriptAddr);
		return;
	}
	...
	fs.writeFile("no", data, function (err) {
		if (err){return console.log("Could not write to destination path")}
		//else {console.log("Success");};
	});
