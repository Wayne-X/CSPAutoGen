...
module.exports = {
	...
	makeUniqHashes: function (hashArr){
	...
	makeHashToGAST: function (uniqHash, allHash){
		mapArr = [];
	...
	makeTemplates: function (mapArr, gasts){
	...
	makeToWrite: function (templates, hashes){
		toWrite = [];
		for (i in templates){
			toWrite[i] = {};
	...
	writeToDatabase: function (dbToWrite, collectionToWrite, toWriteDat){
